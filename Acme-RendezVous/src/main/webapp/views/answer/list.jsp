...
<display:table name="answers" id="answer" requestURI="answer/${actorWS}display.do?userId=${answer.user.id}&rendezVousId=${rendezVous.id}" pagesize="5" style="text-align:center;" class="displaytag">
